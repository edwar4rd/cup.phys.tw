...
#+++    原作者: Tacky 　　電子郵箱 >>> tacky2@ops.dti.ne.jp     個人網站 >>> http://tackysroom.com
#+++    中文化: 驚直　　　電子郵箱 >>> kxxk@pacific.net.hk      個人網站 >>> http://home.pacific.net.hk/~kxxk
...
#─＜基本設定開始＞────────────────────────────────────────────────────────
$url                        = 'http://www.phys.ncyu.edu.tw/~dapsa/';       #首頁的網址
...
$cnt_gif[0]                 = '<img src=../../mkaki/cicon/num6_0.gif width=25 height=30>';
$cnt_gif[1]                 = '<img src=../../mkaki/cicon/num6_1.gif width=25 height=30>';
$cnt_gif[2]                 = '<img src=../../mkaki/cicon/num6_2.gif width=25 height=30>';
$cnt_gif[3]                 = '<img src=../../mkaki/cicon/num6_3.gif width=25 height=30>';
$cnt_gif[4]                 = '<img src=../../mkaki/cicon/num6_4.gif width=25 height=30>';
$cnt_gif[5]                 = '<img src=../../mkaki/cicon/num6_5.gif width=25 height=30>';
$cnt_gif[6]                 = '<img src=../../mkaki/cicon/num6_6.gif width=25 height=30>';
$cnt_gif[7]                 = '<img src=../../mkaki/cicon/num6_7.gif width=25 height=30>';
$cnt_gif[8]                 = '<img src=../../mkaki/cicon/num6_8.gif width=25 height=30>';
$cnt_gif[9]                 = '<img src=../../mkaki/cicon/num6_9.gif width=25 height=30>';
$cnt_keta                   = 5;                                        #計數器要顯示幾多位數字？

$title                      = '大物盃留言板';                             #留言板的標題
$titlelogo                  = '';   #留言板標題圖檔IMG語法 (不使用則改為'')
$backpicture                = '../../mkaki/img/bg.gif';                                       #背景圖檔
$bgcolor                    = 'white';                                  #背景顏色
...
$res_gif                    = '../../mkaki/img/res.gif';                          #設定讓訪客「回覆留言」的圖檔。(不使用則改為'',便會以純文字形式表示)
$gif_spacer                 = '../../mkaki/img/spacer.gif';                       #調整空位的DUMMY圖檔
...
$homelinklogo               = '<img src=../../mkaki/img/kakikomitai_linkhome.gif width=50 height=12 border=0 alt=個人網站>';	#留言者個人網站連結圖檔IMG語法 (不使用則改為'')
$maillinklogo               = '<img src=../../mkaki/img/kakikomitai_linkmail.gif width=50 height=12 border=0 alt=電子郵箱>';	#留言者電子郵箱連結圖檔IMG語法 (不使用則改為'')

$top_l                      = '<img src=../../mkaki/img/top_l_h.gif width=8 height=8>';       #造成留言框圓角效果的圖檔IMG語法 (左上角) (不使用則改為'')
$top_r                      = '<img src=../../mkaki/img/top_r_h.gif width=8 height=8>';       #造成留言框圓角效果的圖檔IMG語法 (右上角) (不使用則改為'')
$bottom_l                   = '<img src=../../mkaki/img/bottom_l_h.gif width=8 height=8>';    #造成留言框圓角效果的圖檔IMG語法 (左下角) (不使用則改為'')
$bottom_r                   = '<img src=../../mkaki/img/bottom_r_h.gif width=8 height=8>';    #造成留言框圓角效果的圖檔IMG語法 (右下角) (不使用則改為'')

$datamax                    = 100 ;                                     #最新的留言集，保留的留言篇數 (只要留言達到這個數目，最原先的留言便會存入舊留言集)
$pagemax                    = 20 ;                                      #１頁可顯示之留言篇數
$password                   = '99102';                                   #管理者密碼
...
#設定留言表格的各個欄目圖檔
$gif_name           = '../../mkaki/img/kakikomitai_name.gif';     #(名字)
$gif_email          = '../../mkaki/img/kakikomitai_email.gif';    #(電子郵箱)
$gif_home           = '../../mkaki/img/kakikomitai_homepage.gif'; #(個人網站)
$gif_title          = '../../mkaki/img/kakikomitai_title.gif';    #(標題)
$gif_message        = '../../mkaki/img/kakikomitai_message.gif';  #(留言內容)
...
$jicon_gif[0] = '../../mkaki/icon/kuma.gif' ;         $jiconnm[0] = 'Ａ君' ;          $jicon_gif_w[0] = 38 ; $jicon_gif_h[0] = 38 ;
$jicon_gif[1] = '../../mkaki/icon/parappa.gif' ;      $jiconnm[1] = 'Ｂ君' ;          $jicon_gif_w[1] = 37 ; $jicon_gif_h[1] = 35 ;

#↓設定留言者一般可選擇之圖檔。可以依個人需要增加其他圖檔如$icon_gif[11]...[20]等，餘此類推。
$icon_gif[0]  = '../../mkaki/icon/ball.gif' ;         $iconnm[0]  = '皮球' ;          $icon_gif_w[0]  = 32 ; $icon_gif_h[0]  = 32 ;
$icon_gif[1]  = '../../mkaki/icon/corgi.gif' ;        $iconnm[1]  = '小狗' ;          $icon_gif_w[1]  = 32 ; $icon_gif_h[1]  = 32 ;
$icon_gif[2]  = '../../mkaki/icon/cow.gif' ;          $iconnm[2]  = '乳牛' ;          $icon_gif_w[2]  = 32 ; $icon_gif_h[2]  = 32 ;
$icon_gif[3]  = '../../mkaki/icon/denchi.gif' ;       $iconnm[3]  = '電池' ;          $icon_gif_w[3]  = 32 ; $icon_gif_h[3]  = 32 ;
$icon_gif[4]  = '../../mkaki/icon/dorayaki.gif' ;     $iconnm[4]  = '燒餅' ;          $icon_gif_w[4]  = 32 ; $icon_gif_h[4]  = 32 ;
$icon_gif[5]  = '../../mkaki/icon/duck.gif' ;         $iconnm[5]  = '鴨子' ;          $icon_gif_w[5]  = 32 ; $icon_gif_h[5]  = 32 ;
$icon_gif[6]  = '../../mkaki/icon/h_bambi.gif' ;      $iconnm[6]  = '松鼠' ;          $icon_gif_w[6]  = 32 ; $icon_gif_h[6]  = 32 ;
$icon_gif[7]  = '../../mkaki/icon/h_bear.gif' ;       $iconnm[7]  = '米熊' ;          $icon_gif_w[7]  = 32 ; $icon_gif_h[7]  = 32 ;
$icon_gif[8]  = '../../mkaki/icon/h_kaeru.gif' ;      $iconnm[8]  = '青蛙' ;          $icon_gif_w[8]  = 32 ; $icon_gif_h[8]  = 32 ;
$icon_gif[9]  = '../../mkaki/icon/h_momo.gif' ;       $iconnm[9]  = 'momo' ;          $icon_gif_w[9]  = 32 ; $icon_gif_h[9]  = 32 ;
$icon_gif[10] = '../../mkaki/icon/h_saru.gif' ;       $iconnm[10] = '猴子' ;          $icon_gif_w[10] = 32 ; $icon_gif_h[10] = 32 ;
...
sub footer {
    ...
    print "中文化及其他修改：<a href=http://home.pacific.net.hk/~kxxk target=_blank>天真的驚直</a> <font face=\"$e_font\">[2001.3.4]</font></span></div>\n";
    #如果你將留言板安裝在HyperMart或Virtual Avenue的主機伺服器上，你可以拿掉下面的＃號直接在留言板掃出廣告，避免再彈出來令人厭惡的廣告。    (驚直加入)
#	print "<br><span style=\"font-size:$pt_mini;font-family:$e_font\"><!--#echo banner=\"\"--></span>\n";	#HyperMart/VirtualAve廣告語法
    print "</body></html>\n";
}
###<--------------------------------------------------------------
###<---   讀取記錄檔
